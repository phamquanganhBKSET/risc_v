...
add wave -noupdate -expand -group STAGE_IF /riscv_tb/riscv/stage_IF/IF_flush
add wave -noupdate -expand -group STAGE_IF /riscv_tb/riscv/stage_IF/IF_ID_write
add wave -noupdate -expand -group STAGE_IF /riscv_tb/riscv/stage_IF/pc
add wave -noupdate -expand -group STAGE_IF /riscv_tb/riscv/stage_IF/pc_next
add wave -noupdate -expand -group STAGE_IF /riscv_tb/riscv/stage_IF/inst
add wave -noupdate -expand -group STAGE_IF /riscv_tb/riscv/stage_IF/pre_pc
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/clk
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/reset_n
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/pc
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/inst
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/IF_ID_pc
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/IF_ID_inst
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/IF_ID_inst_opcode
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/IF_ID_rs1
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/IF_ID_rs2
add wave -noupdate -group REG_IF_ID /riscv_tb/riscv/reg_IF_ID/IF_ID_rd
...
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/clk
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/reset_n
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/IF_ID_pc
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/IF_ID_inst
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/IF_ID_rs1
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/IF_ID_rs2
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/MEM_WB_reg_wr_en
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/MEM_WB_rd
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/WB_data
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/forward_comp1
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/forward_comp2
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/alu_out
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/DMEM_data_out
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/pc_imm
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/pc_sel
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/data_out_1
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/data_out_2
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/imm_out
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/reg_write_en
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/alu_sel
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/mem_write_en
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/ASel
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/BSel
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/wb_sel
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/data_rs1
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/data_rs2
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/imm_sel
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/br_un
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/br_eq
add wave -noupdate -group {Stage ID} /riscv_tb/riscv/stage_ID/br_lt
...
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/clk
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/reset_n
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/forwardA
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/forwardB
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/ID_EX_data_out_1
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/ID_EX_data_out_2
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/ID_EX_imm_out
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/WB_data
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/EX_MEM_alu_out
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/ID_EX_alu_sel
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/ID_EX_ASel
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/ID_EX_BSel
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/alu_out
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/dataB
add wave -noupdate -group STAGE_EX /riscv_tb/riscv/stage_EX/dataA
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/clk
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/reset_n
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/alu_out
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/dataB
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/ID_EX_inst_opcode
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/ID_EX_rs1
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/ID_EX_rs2
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/ID_EX_rd
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/ID_EX_reg_write_en
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/ID_EX_mem_write_en
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/ID_EX_wb_sel
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_alu_out
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_dataB
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_inst_opcode
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_rs1
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_rs2
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_rd
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_reg_write_en
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_mem_write_en
add wave -noupdate -group reg_EX_MEM /riscv_tb/riscv/reg_EX_MEM/EX_MEM_wb_sel
